      ...
      style = ''
        * {
        ...
        #clock {
          ...
          background: linear-gradient(118deg, rgba(30, 30, 46, 1) 5%, rgba(249, 226, 175, 1) 5%, rgba(249, 226, 175, 1) 20%, rgba(30, 30, 46, 1) 20%, rgba(30, 30, 46, 1) 40%, rgba(249, 226, 175, 1) 40%, rgba(249, 226, 175, 1) 60%, rgba(30, 30, 46, 1) 60%, rgba(30, 30, 46, 1) 80%, rgba(249, 226, 175, 1) 80%, rgba(249, 226, 175, 1) 95%, rgba(30, 30, 46, 1) 95%);
